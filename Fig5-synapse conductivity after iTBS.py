...
simConfig.duration = 195*1e3        # Duration of the simulation, in ms  
...
for amplitude1 in  range (99,159,4): 
    def Simulation(amplitude2):
        simConfig.filename='iTBS-pre-'+str(amplitude1)+'post-'+str(amplitude2)
        start_time=1000
    ...
    ModelOutput=Parallel(n_jobs=num_cores)(delayed(Simulation)(amplitude2) for amplitude2 in range (40,150,4))   # range (140,150,4))
