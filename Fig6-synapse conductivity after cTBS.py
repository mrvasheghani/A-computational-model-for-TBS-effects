...
def Simulation(amp_pre, amp_post):
    simConfig.filename='cTBS-pre-'+str(amp_pre)+'post-'+str(amp_post)
    # COUNT=0
...
for chunk in chunks:
    ...
    for i in range (chunk_size):
        ...
        filename='cTBS-pre-'+str(pre_a)+'post-'+str(post_a)

        voltage_cut=[]
        time_cut=[]
        for j in range (840000,840200,1): 
