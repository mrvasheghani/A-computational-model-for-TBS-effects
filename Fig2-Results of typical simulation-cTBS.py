...
simConfig.duration = 43*1e3         # Duration of the simulation, in ms
...
for amplitude1 in range (119,120,1):
    ...
    ModelOutput=Parallel(n_jobs=num_cores)(delayed(Simulation)(amplitude2) for amplitude2 in range (80,81,1))  
